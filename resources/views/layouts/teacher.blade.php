            ...
            <nav class="h-full overflow-y-auto px-3 py-4">
                ...
                <div class="space-y-1">
                    <div class="space-y-1">
                        ...
                        class="sidebar-item flex items-center gap-3 px-3 py-3 mb-1 rounded-lg transition duration-200
                                hover:bg-gray-700 dark:hover:bg-gray-800
                                {{ request()->routeIs('teacher.courses') ? 'bg-gray-700 dark:bg-gray-800 text-white font-semibold' : 'text-gray-300' }} group/item">
                            <svg class="w-6 h-6 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        class="sidebar-item flex items-center gap-3 px-3 py-3 mb-1 rounded-lg transition duration-200
                                hover:bg-gray-700 dark:hover:bg-gray-800
                                {{ request()->routeIs('teacher.quiz') ? 'bg-gray-700 dark:bg-gray-800 text-white font-semibold' : 'text-gray-300' }} group/item">
                            <svg class="w-6 h-6 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
