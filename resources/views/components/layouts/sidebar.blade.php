...
<div class="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:flex-col" 
  ...
  <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-gray-900 transition-all duration-300"
    ...
    <!-- Toggle button -->
    <button @click="toggleSidebar" class="flex items-center justify-center rounded-md text-gray-400 hover:text-white hover:bg-gray-800 self-end">
    ...
    <x-layouts.sidebar-content :collapsed="false" />
  </div>
</div>
    ...
    <div class="fixed inset-0 flex">
      <div x-show="open"
        ...
        <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-gray-900 px-6 pb-4">
          ...
          <x-.layouts.sidebar-content :collapsed="false" :mobile="true" />
        </div>
      </div>
    </div>
  </div>
